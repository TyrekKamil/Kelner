package neural.network.ml.ui;

import neural.network.ml.vg16.PetType;
import neural.network.ml.vg16.VG16ForCat;
...
public class UI {
    ...
    public void chooseFileAction() {
        ...
        chooser.setCurrentDirectory(new File(new File("/CatAndDogRecognizer/resources").getAbsolutePath()));
